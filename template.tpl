...
[
  ...
  },
  {
    "type": "PARAM_TABLE",
    "name": "macros",
    "displayName": "Segmentation Parameters",
    "paramTableColumns": [
      {
        "param": {
          "type": "SELECT",
    ...
    "help": "You can use Segmentation Parameters to pass data to Opticks Sensor whenever its loaded and before analyses the visitor. This is useful to load segmentation data coming from your DataLayer variables."
  }
]
...
var domain = "https://protect.cleansafesecurebest.com";

logToConsole('Opticks Integration: data = ' + JSON.stringify(data));

var url = domain + '/j/' + data.sensorId;
if (data.macros) {
  for (let i = 0; i < data.macros.length; ++i) {
    if(i===0) {
      url += '?';
    }
    url += '&' + data.macros[i].macro + '=' + encodeUriComponent(data.macros[i].value);
  }
}

logToConsole('Opticks Integration: loading script from url"' + url + '"');
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              ...
              {
                "type": 1,
                "string": "https://protect.cleansafesecurebest.com/*"
              }
            ]
          }
        }
...
Created on 10/25/2022, 6:36:54 PM
